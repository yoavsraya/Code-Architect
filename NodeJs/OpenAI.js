...
async function RunAI() {
  ...
  const assistantMessage = completion.choices[0].message.content;//tempAIResponseGarageManager;
...
async function ExpandTopic(topic, fileContents) {
  ...
  const assistantMessage = completion.choices[0].message.content;  //tempAIResponseExpandFactoryPattern;
